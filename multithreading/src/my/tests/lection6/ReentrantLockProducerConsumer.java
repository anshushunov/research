...
// some example from internet for multiple conditions
// https://www.zoftino.com/java-concurrency-lock-and-condition-examples#condition-example
...
class Message {
    ...
    public void publishMessage(String message) {
        ...
        try {
            ...
            System.out.println("adding latest message: " + message);
